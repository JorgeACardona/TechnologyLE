...
export function Cfuncionales() {
    return (
        ...
        <body id="body">
            ...
            <p>Son los encargados de procesar todas las instrucciones <br/>
                que proporciona el software con el cual está cargada la computadora.</p>

            <div id="cont-informacion">
                <h2>Microprocesador</h2>
                <p>Es el cerebro del ordenador, el que se encarga de analizar absolutamente toda
            ...
            <div id="cont-informacion">
                <h2>Disipadores y refrigeración líquida</h2>
