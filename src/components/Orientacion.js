...
export function Orientacion() {
    ...
    return (
        ...
        <body id="body">
            ...
            <form  id="form">
                <p><strong>¿Para qué usarías el computador?</strong></p>
                <ol>
                ...
                <p><strong>¿Cuál es tu presupuesto?</strong></p>
                <ol>
                ...
                <p><strong>¿Prefieres compuitador de escritorio o portátil?</strong></p>
                <ol>
